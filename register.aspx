...
<asp:Content ID="Content1" ContentPlaceHolderID="cpcMainContent" Runat="Server">
    ...
    <div class="span7" runat="server" id="divMain">
            ...
            <h2 class="form-signin-heading">CERICO Registration</h2>
             <asp:Panel ID="panMain" runat="server" Visible="true">
                <h3>Supplier&#39;s get certified and customers gain compliance, make all the connections.<br />For free.</h3>
                <p>Items marked with <span class="alert-error">*</span> are requried</p>
                    ...
                    <div class="control-group">
                            <label class="control-label"><asp:Label ID="SurnameLabel" runat="server" AssociatedControlID="txtSurname"><span class="alert-error">* </span>Surname:</asp:Label></label>
                                <div class="controls">
                                <asp:TextBox ID="txtSurname" runat="server" CssClass="input-large"></asp:TextBox>
                         ...
                         <div class="control-group">
                            ...
                            <asp:TextBox ID="txtEmailAddress" runat="server" CssClass="input-xlarge" /><br />
                       ...
                       <asp:TextBox ID="txtRegisterUserName" runat="server" CssClass="input-large"></asp:TextBox><br />
                       ...
                       <div class="control-group">
                           ...
                           <asp:TextBox ID="txtRegisterPassword" runat="server" CssClass="input-medium" TextMode="Password" ></asp:TextBox><br />
    ...
    CalculationWeightings="70;30;0;0" />
                        ...
                        <div class="control-group">
                           ...
                           <asp:TextBox ID="txtPasswordConfirm" runat="server" CssClass="input-medium" TextMode="Password" ></asp:TextBox><br />
