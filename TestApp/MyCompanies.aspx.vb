...
'  Description      : Shows company summaries           ' 
...
Public Class MyCompanies
    ...
    Protected Sub GetMyRelationships(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Protected Sub BindCompanies(sender As Object, e As System.Web.UI.WebControls.RepeaterItemEventArgs)
